...
<nav class="navbar navbar-expand-lg">
    ...
    <a class="navbar-brand d-flex align-items-center" href="{{ url('/admindashboard') }}">
            ...
            <ul class="navbar-nav ms-auto me-5 align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown">
                        <img src="{{ asset('storage/' . auth()->user()->image) }}" class="rounded-circle me-2" alt="Profile" width="45" height="45">
